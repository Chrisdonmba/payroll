...
registerUser.addEventListener('submit', (e) => {
    ...
    const fName = registerUser.fName.value;
    const email = registerUser.email.value;
    const phone = registerUser.phone.value;
    const dob = registerUser.dob.value;
    const age = registerUser.age.value;
    const salary = registerUser.salary.value;
    const department = registerUser.department.value;
    const position = registerUser.position.value;
    const gender = registerUser.gender.value;
    ...
    const formData = { fName, email, phone, dob, age, salary, department, position, gender };
